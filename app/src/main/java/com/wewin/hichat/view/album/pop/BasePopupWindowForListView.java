package com.wewin.hichat.view.album.pop;
...
public abstract class BasePopupWindowForListView<T> extends PopupWindow {
    ...
    public BasePopupWindowForListView(View contentView, int width, int height,
                                      boolean focusable, List<T> dataList) {
        this(contentView, width, height, focusable, dataList, new Object[0]);

    }

    public BasePopupWindowForListView(View contentView, int width, int height,
                                      boolean focusable, List<T> dataList, Object... params) {
