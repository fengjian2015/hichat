...
public class HttpContact {
    ...
    //找人
    public static void searchFriend(int page, String type, String phoneNum,
     ...
     */
    public static void uploadFile(String filePath, int flag, String toId, String type,
                                  HttpCallBack httpCallBack){
        uploadFile(new File(filePath), flag, toId, type, httpCallBack);
    }

    private static void uploadFile(File file, int flag, String toId, String type,
                                  HttpCallBack httpCallBack){
        Map<String, String> map = new HashMap<>();
    ...
    //群消息置顶
    public static void makeTopGroup(String id, int topMark, HttpCallBack httpCallBack){
        Map<String, String> map = new HashMap<>();
        map.put("id", id);
        map.put("topMark", String.valueOf(topMark));
