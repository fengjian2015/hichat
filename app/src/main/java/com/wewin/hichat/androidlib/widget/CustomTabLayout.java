...
public class CustomTabLayout extends HorizontalScrollView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mTextSize = typedArray.getInt(R.styleable.CustomTabLayout_ctlTextSize, 15);
            ...
            mUnderlineWidth = typedArray.getInt(R.styleable.CustomTabLayout_ctlUnderlineWidth, 20);
            mUnderlineHeight = typedArray.getInt(R.styleable.CustomTabLayout_ctlUnderlineHeight, 2);
            mUnderlineCol = typedArray.getInt(R.styleable.CustomTabLayout_ctlUnderlineColor, Color.parseColor("#3F51B5"));
