...
public class CircleImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mPressColor = array.getColor(R.styleable.CircleImageView_press_color, mPressColor);
            mPressAlpha = array.getInteger(R.styleable.CircleImageView_press_alpha, mPressAlpha);
